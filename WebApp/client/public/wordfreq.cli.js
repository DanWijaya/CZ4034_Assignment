...
optimist.usage(
  "Calculate text corpus from given file/stdin.\n" +
    "Usage: $0 [options] [filename]",
  {
    min: {
      description:
        "Minimal count required to be included in the returned list.",
      short: "m",
    },
    lang: {
    ...
    "stop-word-sets": {
      description:
        "Specify the built-in set of stop words to exclude in the count. " +
    ...
    "no-filter-substring": {
      description:
        "(Chinese language only) Don't filter out the recounted substring.",
    },
    "max-length": {
      description:
        "(Chinese language only) Maxium length to consider a phrase. Default to 8.",
    },
  }
);
